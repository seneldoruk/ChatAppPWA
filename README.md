...
| Biometric Auth     |                                                                                        |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Contact Picker     |                [NewChat.tsx](frontend/src/components/main/NewChat.tsx)                 | It is an experimental API only implemented in Chrome in Android and in none of the other platforms/OSs/browsers.                                                                                                                                                                                                                                                                                                                                                                                                        |
...
Update: It seems like [Apple is banning PWAs in Europe](https://9to5mac.com/2024/02/15/ios-17-4-web-apps-european-union/). 
So "PWAs as a cross platform alternative to native app development" will no longer be a thing, at least in the EU. 
